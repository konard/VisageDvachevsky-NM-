...
public:
    ...
    [[nodiscard]] const std::vector<PropertyTrack>& getPropertyTracks() const { return m_propertyTracks; }
...
public:
    ...
    [[nodiscard]] const std::vector<std::unique_ptr<TimelineClip>>& getClips() const { return m_clips; }
    ...
    [[nodiscard]] const std::vector<std::unique_ptr<TimelineTrack>>& getChildTracks() const { return m_childTracks; }
...
public:
    ...
    [[nodiscard]] const std::vector<std::unique_ptr<TimelineTrack>>& getTracks() const { return m_tracks; }
...
public:
    ...
    void setOnMarkerReached(std::function<void(const Timeline::Marker&)> callback) { m_onMarkerReached = callback; }
