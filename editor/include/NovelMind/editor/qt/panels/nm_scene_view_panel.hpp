...
{
public:
    explicit NMSceneObject(const QString& id, NMSceneObjectType type, QGraphicsItem* parent = nullptr);
...
public:
    ...
    void clearSelection();
    [[nodiscard]] NMSceneObject* selectedObject() const { return m_selectedObject; }
