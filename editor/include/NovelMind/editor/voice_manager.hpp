 ...
 */
using OnVoiceBindingChanged = std::function<void(const std::string& lineId, const std::string& voiceFile)>;
...
public:
     ...
     */
    [[nodiscard]] std::vector<const DialogueLine*> getFilteredLines(const VoiceLineFilter& filter) const;
     ...
     */
    [[nodiscard]] std::vector<const DialogueLine*> getLinesForCharacter(const std::string& characterId) const;
     ...
     */
    [[nodiscard]] const std::vector<VoiceMappingPattern>& getMappingPatterns() const { return m_mappingPatterns; }
...
private:
    ...
    // Export helpers
    Result<void> exportCSV(const std::string& path, const std::vector<const DialogueLine*>& lines) const;
    Result<void> exportJSON(const std::string& path, const std::vector<const DialogueLine*>& lines) const;
    Result<void> exportTSV(const std::string& path, const std::vector<const DialogueLine*>& lines) const;
