...
public:
     ...
     */
    [[nodiscard]] virtual Result<AssetMetadata> import(
     ...
     */
    [[nodiscard]] virtual Result<AssetMetadata> reimport(
...
public:
    ...
    [[nodiscard]] Result<AssetMetadata> import(
        const std::string& sourcePath,
        const std::string& destPath,
        AssetDatabase* database) override;
    [[nodiscard]] Result<AssetMetadata> reimport(
        const AssetMetadata& existing,
        AssetDatabase* database) override;
