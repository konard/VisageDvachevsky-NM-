    ...
    switch (event.type)
    {
        case QtEditorEventType::SelectionChanged:
            emit selectionChanged(
                event.data.value("selectedIds").toStringList(),
        ...
        case QtEditorEventType::PropertyChanged:
            emit propertyChanged(
                event.data.value("objectId").toString(),
        ...
        case QtEditorEventType::LogMessage:
            emit logMessage(
                event.data.value("message").toString(),
...
void QtEventBus::publishSelectionChanged(const QStringList& selectedIds, const QString& selectionType)
{
    QtEditorEvent event;
