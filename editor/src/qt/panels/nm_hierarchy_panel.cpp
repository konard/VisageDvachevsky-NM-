...
NMHierarchyTree::NMHierarchyTree(QWidget* parent)
    : QTreeWidget(parent)
{
...
void NMHierarchyTree::selectionChanged(const QItemSelection& selected, const QItemSelection& deselected)
{
...
void NMHierarchyPanel::setupContent()
{
    ...
    connect(m_tree, &NMHierarchyTree::itemDoubleClicked, this, &NMHierarchyPanel::objectDoubleClicked);
