...
void NMIconManager::initializeIcons()
{
    ...
    m_iconSvgData["file-new"] =
        ...
        "<path fill='%COLOR%' d='M14 3h-2V1c0-.55-.45-1-1-1H1C.45 0 0 .45 0 1v14c0 .55.45 1 1 1h10c.55 0 1-.45 1-1v-2h2c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1zM11 15H1V1h10v14zm3-3h-2V4h2v8z'/>"
        "<path fill='%COLOR%' d='M3 6h6v1H3zm0 2h6v1H3zm0 2h6v1H3z'/>"
        "</svg>";

    m_iconSvgData["file-open"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M14 4h-4.38l-1.3-1.3c-.2-.2-.45-.7-.7-.7H1c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h13c.55 0 1-.45 1-1V5c0-.55-.45-1-1-1zm0 9H1V3h5l2 2h6v8z'/>"
        "</svg>";

    m_iconSvgData["file-save"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M14 0H2C.9 0 0 .9 0 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V2c0-1.1-.9-2-2-2zM5 2h6v3H5V2zm9 12H2V2h1v4h10V2h1v12z'/>"
    ...
    m_iconSvgData["file-close"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M14 3h-2V1c0-.55-.45-1-1-1H1C.45 0 0 .45 0 1v14c0 .55.45 1 1 1h10c.55 0 1-.45 1-1v-2h2c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1zM11 15H1V1h10v14z'/>"
        "<path fill='%COLOR%' d='M10.3 4.7l-1.4-1.4L8 4.2 7.1 3.3 5.7 4.7 6.6 5.6 5.7 6.5l1.4 1.4.9-.9.9.9 1.4-1.4-.9-.9z'/>"
        "</svg>";
    ...
    m_iconSvgData["edit-undo"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M8 1c-1.7 0-3.3.6-4.6 1.7L1 1v5h5L3.5 3.5C4.5 2.6 6.2 2 8 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6H1c0 3.9 3.1 7 7 7s7-3.1 7-7-3.1-7-7-7z'/>"
        "</svg>";

    m_iconSvgData["edit-redo"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M8 1c1.7 0 3.3.6 4.6 1.7L15 1v5h-5l2.5-2.5C11.5 2.6 9.8 2 8 2 4.7 2 2 4.7 2 8s2.7 6 6 6 6-2.7 6-6h1c0 3.9-3.1 7-7 7s-7-3.1-7-7 3.1-7 7-7z'/>"
        "</svg>";

    m_iconSvgData["edit-cut"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M13.5 3l-6 6-2-2L3 9.5c-.8.8-.8 2.1 0 2.8.8.8 2.1.8 2.8 0L8.5 9.7l2 2 5-5-2-3.7zM4.5 11c-.3 0-.5-.2-.5-.5s.2-.5.5-.5.5.2.5.5-.2.5-.5.5z'/>"
        "<circle fill='%COLOR%' cx='4.5' cy='3.5' r='1.5'/>"
        "</svg>";

    m_iconSvgData["edit-copy"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M13 0H3C2.4 0 2 .4 2 1v2H0v11c0 .6.4 1 1 1h10c.6 0 1-.4 1-1v-2h2c.6 0 1-.4 1-1V1c0-.6-.4-1-1-1zm-2 14H1V4h10v10zm2-3h-1V4c0-.6-.4-1-1-1H4V1h9v10z'/>"
        "</svg>";

    m_iconSvgData["edit-paste"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M11 2h1c.6 0 1 .4 1 1v11c0 .6-.4 1-1 1H4c-.6 0-1-.4-1-1V3c0-.6.4-1 1-1h1V1h6v1zM5 4v10h6V4H5z'/>"
        "<rect fill='%COLOR%' x='6' y='0' width='4' height='2' rx='1'/>"
        "</svg>";

    m_iconSvgData["edit-delete"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M13 3h-2V1c0-.55-.45-1-1-1H6c-.55 0-1 .45-1 1v2H3c-.55 0-1 .45-1 1v1h12V4c0-.55-.45-1-1-1zM6 1h4v2H6V1z'/>"
        "<path fill='%COLOR%' d='M4 6v9c0 .55.45 1 1 1h6c.55 0 1-.45 1-1V6H4zm2 8H5V8h1v6zm2 0H7V8h1v6zm2 0H9V8h1v6z'/>"
        "</svg>";
    ...
    m_iconSvgData["panel-scene"] =
        "<svg viewBox='0 0 16 16'>"
        "<rect fill='%COLOR%' x='2' y='2' width='12' height='12' rx='1' fill='none' stroke='%COLOR%' stroke-width='1.5'/>"
    ...
    m_iconSvgData["panel-graph"] =
        ...
        "<path fill='none' stroke='%COLOR%' stroke-width='1.5' d='M5 8h6M5 7l3-2M11 7l-3-2'/>"
        "</svg>";
    ...
    m_iconSvgData["panel-hierarchy"] =
        ...
        "<path fill='none' stroke='%COLOR%' stroke-width='1' d='M4 4h2M6 4v3M6 7h2M6 7v4M6 11h2M8 7h2'/>"
        "</svg>";
    ...
    m_iconSvgData["panel-curve"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='none' stroke='%COLOR%' stroke-width='1.5' d='M2 14Q5 2 8 8T14 2'/>"
    ...
    m_iconSvgData["panel-voice"] =
        ...
        "<path fill='%COLOR%' d='M4 7v1c0 2.2 1.8 4 4 4s4-1.8 4-4V7h1v1c0 2.5-1.8 4.6-4.2 4.9V15h2v1H5v-1h2v-2.1C4.8 12.6 3 10.5 3 8V7h1z'/>"
        "</svg>";

    m_iconSvgData["panel-localization"] =
        "<svg viewBox='0 0 16 16'>"
        "<circle fill='none' stroke='%COLOR%' stroke-width='1.5' cx='8' cy='8' r='6'/>"
        "<path fill='none' stroke='%COLOR%' stroke-width='1.5' d='M2 8h12M8 2c-1.5 0-3 2.7-3 6s1.5 6 3 6 3-2.7 3-6-1.5-6-3-6z'/>"
        "</svg>";
    ...
    m_iconSvgData["panel-build"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M13.8 6.2l-4-4c-.3-.3-.7-.2-1 0l-1 1c-.3.3-.3.7 0 1l1.3 1.3-5.4 5.4-1.3-1.3c-.3-.3-.7-.3-1 0l-1 1c-.3.3-.3.7 0 1l4 4c.3.3.7.3 1 0l1-1c.3-.3.3-.7 0-1l-1.3-1.3 5.4-5.4 1.3 1.3c.3.3.7.3 1 0l1-1c.3-.3.3-.7 0-1z'/>"
        "</svg>";
    ...
    m_iconSvgData["zoom-in"] =
        "<svg viewBox='0 0 16 16'>"
        "<circle fill='none' stroke='%COLOR%' stroke-width='1.5' cx='6.5' cy='6.5' r='4.5'/>"
    ...
    m_iconSvgData["zoom-fit"] =
        "<svg viewBox='0 0 16 16'>"
        "<rect fill='none' stroke='%COLOR%' stroke-width='1.5' x='2' y='2' width='12' height='12'/>"
        "<path fill='%COLOR%' d='M5 5h2V4H4v3h1zM11 5h-2V4h3v3h-1zM11 11h-2v1h3v-3h-1zM5 11h2v1H4v-3h1z'/>"
        "</svg>";
    ...
    m_iconSvgData["settings"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M14.5 6.6l-1.4-.4c-.1-.3-.2-.6-.4-.9l.7-1.3c.2-.4.1-.8-.2-1.1l-.8-.8c-.3-.3-.7-.4-1.1-.2l-1.3.7c-.3-.2-.6-.3-.9-.4L8.7 1c-.1-.5-.5-.8-1-.8h-1.1c-.5 0-.9.3-1 .8l-.4 1.4c-.3.1-.6.2-.9.4L3 2.1c-.4-.2-.8-.1-1.1.2l-.8.8c-.3.3-.4.7-.2 1.1l.7 1.3c-.2.3-.3.6-.4.9L.2 6.8c-.5.1-.8.5-.8 1v1.1c0 .5.3.9.8 1l1.4.4c.1.3.2.6.4.9l-.7 1.3c-.2.4-.1.8.2 1.1l.8.8c.3.3.7.4 1.1.2l1.3-.7c.3.2.6.3.9.4l.4 1.4c.1.5.5.8 1 .8h1.1c.5 0 .9-.3 1-.8l.4-1.4c.3-.1.6-.2.9-.4l1.3.7c.4.2.8.1 1.1-.2l.8-.8c.3-.3.4-.7.2-1.1l-.7-1.3c.2-.3.3-.6.4-.9l1.4-.4c.5-.1.8-.5.8-1V7.6c0-.5-.3-.9-.8-1zM8 11c-1.7 0-3-1.3-3-3s1.3-3 3-3 3 1.3 3 3-1.3 3-3 3z'/>"
        "</svg>";

    m_iconSvgData["help"] =
        "<svg viewBox='0 0 16 16'>"
        "<circle fill='none' stroke='%COLOR%' stroke-width='1.5' cx='8' cy='8' r='6'/>"
        "<path fill='%COLOR%' d='M8 6c-.8 0-1.5.7-1.5 1.5h-1C5.5 6.1 6.6 5 8 5s2.5 1.1 2.5 2.5c0 1-.6 1.8-1.5 2.2v.8h-1v-1.2c0-.3.2-.5.5-.5.8 0 1.5-.7 1.5-1.5S8.8 5.8 8 5.8z'/>"
    ...
    m_iconSvgData["refresh"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M14 2v5h-5l2-2C9.7 3.7 8 3 8 3 4.7 3 2 5.7 2 9s2.7 6 6 6c2.8 0 5.2-2 5.8-4.6h1.1C14.3 13.6 11.4 16 8 16c-3.9 0-7-3.1-7-7s3.1-7 7-7c1.9 0 3.6.8 4.9 2l2-2z'/>"
        "</svg>";
    ...
    m_iconSvgData["warning"] =
        "<svg viewBox='0 0 16 16'>"
        "<path fill='%COLOR%' d='M8 1L1 14h14L8 1zm0 4h1v5H8V5zm.5 7c-.3 0-.5-.2-.5-.5s.2-.5.5-.5.5.2.5.5-.2.5-.5.5z'/>"
        "</svg>";
