...
void NMUndoManager::initialize()
{
    ...
    // Connect signals
    connect(m_undoStack.get(), &QUndoStack::canUndoChanged,
            this, &NMUndoManager::canUndoChanged);
    connect(m_undoStack.get(), &QUndoStack::canRedoChanged,
            this, &NMUndoManager::canRedoChanged);
    connect(m_undoStack.get(), &QUndoStack::undoTextChanged,
            this, &NMUndoManager::undoTextChanged);
    connect(m_undoStack.get(), &QUndoStack::redoTextChanged,
            this, &NMUndoManager::redoTextChanged);
    connect(m_undoStack.get(), &QUndoStack::cleanChanged,
            this, &NMUndoManager::cleanChanged);
    connect(m_undoStack.get(), &QUndoStack::indexChanged,
            this, &NMUndoManager::indexChanged);
...
{
    // TODO: Implement property change undo by interfacing with the property system
    core::Logger::instance().info("Undo property change: " + text().toStdString());
}

void PropertyChangeCommand::redo()
{
    // TODO: Implement property change redo
    core::Logger::instance().info("Redo property change: " + text().toStdString());
}
...
CreateGraphNodeCommand::CreateGraphNodeCommand(
...
DeleteGraphNodeCommand::DeleteGraphNodeCommand(
...
ConnectGraphNodesCommand::ConnectGraphNodesCommand(
