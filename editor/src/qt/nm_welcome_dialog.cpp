...
NMWelcomeDialog::NMWelcomeDialog(QWidget* parent)
    : QDialog(parent)
{
...
void NMWelcomeDialog::setupUI()
{
    ...
    connect(skipCheckbox, &QCheckBox::toggled, [this](bool checked) {
        m_skipInFuture = checked;
    });
...
void NMWelcomeDialog::setupLeftPanel()
{
    ...
    connect(m_btnBrowseExamples, &QPushButton::clicked, this, &NMWelcomeDialog::onBrowseExamplesClicked);
    ...
    connect(m_recentProjectsList, &QListWidget::itemClicked,
            this, &NMWelcomeDialog::onRecentProjectClicked);
...
void NMWelcomeDialog::setupRightPanel()
{
    ...
    QVector<Resource> resources = {
        {"Getting Started Guide", "Learn the basics of NovelMind Editor", "https://github.com/VisageDvachevsky/NM-"},
        {"Tutorial Videos", "Video tutorials for common tasks", "https://github.com/VisageDvachevsky/NM-"},
        {"API Documentation", "Complete API reference", "https://github.com/VisageDvachevsky/NM-"},
        {"Community Forum", "Ask questions and share projects", "https://github.com/VisageDvachevsky/NM-/discussions"},
        {"Report Issues", "Found a bug? Let us know!", "https://github.com/VisageDvachevsky/NM-/issues"}
    };
...
QWidget* NMWelcomeDialog::createTemplateCard(const ProjectTemplate& tmpl, int index)
{
    ...
    iconLabel->setText("\U0001F4C4");  // Document emoji as placeholder
...
void NMWelcomeDialog::onOpenProjectClicked()
{
    QString projectPath = QFileDialog::getOpenFileName(
        this,
        "Open NovelMind Project",
        QString(),
        "NovelMind Projects (*.nmproj);;All Files (*)"
    );
...
{
    QDesktopServices::openUrl(QUrl("https://github.com/VisageDvachevsky/NM-/tree/main/examples"));
}
