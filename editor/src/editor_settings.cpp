...
EditorLayout LayoutManager::createPresetLayout(LayoutPreset preset)
{
    ...
    switch (preset)
    {
        ...
        case LayoutPreset::SceneFocused:
            ...
            layout.panels = {
                {"Scene", true, true, 0, 0, 1200, 700, "center", 0},
                {"Inspector", true, true, 1200, 0, 300, 400, "right", 0},
        ...
        case LayoutPreset::DebugLayout:
            ...
            layout.panels = {
                {"Scene", true, true, 0, 0, 800, 500, "center", 0},
        ...
        case LayoutPreset::Minimal:
            ...
            layout.panels = {
                {"Scene", true, true, 0, 0, 1400, 900, "center", 0}
            };
            break;
...
void HotkeyManager::registerDefaultHotkeys(EditorApp* editor)
{
    ...
    // File actions
    registerAction({
        "file.new_project", "New Project", "Create a new project",
        ActionCategory::File,
        {static_cast<i32>('N'), KeyModifier::Ctrl | KeyModifier::Shift},
        {static_cast<i32>('N'), KeyModifier::Ctrl | KeyModifier::Shift}
    }, [editor]() { /* editor->newProject(); */ (void)editor; });

    registerAction({
        "file.open_project", "Open Project", "Open an existing project",
        ActionCategory::File,
        {static_cast<i32>('O'), KeyModifier::Ctrl | KeyModifier::Shift},
        {static_cast<i32>('O'), KeyModifier::Ctrl | KeyModifier::Shift}
    }, [editor]() { /* editor->openProject(); */ (void)editor; });

    registerAction({
        "file.save", "Save", "Save current file",
        ActionCategory::File,
    ...
    // Build actions
    registerAction({
        "build.build", "Build", "Build project",
    ...
    // Navigation actions
    registerAction({
        "nav.next_error", "Next Error", "Go to next error",
    ...
    registerAction({
        "nav.prev_error", "Previous Error", "Go to previous error",
        ActionCategory::Navigation,
