...
TransitionType SlideTransition::getType() const
{
    switch (m_direction)
    {
        case Direction::Left:  return TransitionType::SlideLeft;
        case Direction::Right: return TransitionType::SlideRight;
        case Direction::Up:    return TransitionType::SlideUp;
        case Direction::Down:  return TransitionType::SlideDown;
    }
                                               ...
                                               const renderer::Color& color)
{
    switch (type)
    {
        ...
        case TransitionType::Zoom:
            // Not yet implemented, fall back to fade
            return std::make_unique<FadeTransition>(color, true);
    }
...
{
    if (name == "none") return TransitionType::None;
    if (name == "fade") return TransitionType::Fade;
    if (name == "fadethrough" || name == "fade_through") return TransitionType::FadeThrough;
    if (name == "slideleft" || name == "slide_left") return TransitionType::SlideLeft;
    if (name == "slideright" || name == "slide_right") return TransitionType::SlideRight;
    if (name == "slideup" || name == "slide_up") return TransitionType::SlideUp;
    if (name == "slidedown" || name == "slide_down") return TransitionType::SlideDown;
    if (name == "dissolve") return TransitionType::Dissolve;
    if (name == "wipe") return TransitionType::Wipe;
    if (name == "zoom") return TransitionType::Zoom;
...
const char* transitionTypeName(TransitionType type)
{
    switch (type)
    {
        ...
        case TransitionType::FadeThrough: return "fadethrough";
