...
void DebugOverlay::setMetric(const std::string& name, const std::string& value, const std::string& category)
{
    DebugMetric metric;
    metric.name = name;
    metric.value = value;
...
void DebugOverlay::setMetric(const std::string& name, f64 value, const std::string& category, int precision)
{
