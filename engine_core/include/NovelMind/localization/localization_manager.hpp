 ...
 * std::string hello = loc.get("hello_name", {{"name", "Alex"}}); // "Hello, Alex!"
 *
 * // Get plural form
...
public:
     ...
     */
    [[nodiscard]] std::string get(const std::string& id,
     ...
     */
    [[nodiscard]] std::string getPlural(const std::string& id, i64 count,
                                         const std::unordered_map<std::string, std::string>& variables) const;
     ...
     */
    [[nodiscard]] std::string interpolate(const std::string& text,
                                           const std::unordered_map<std::string, std::string>& variables) const;
