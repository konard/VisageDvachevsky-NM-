...
struct CameraPathPoint
{
    ...
    scene::EasingType easing = scene::EasingType::EaseInOut;
};
...
public:
    ...
    void moveTo(f32 x, f32 y, f32 duration, scene::EasingType easing = scene::EasingType::EaseInOut);

    // Zoom
    void setZoom(f32 zoom);
    [[nodiscard]] f32 getZoom() const { return m_zoom; }

    void zoomTo(f32 zoom, f32 duration, scene::EasingType easing = scene::EasingType::EaseInOut);
    void zoomAt(f32 zoom, f32 x, f32 y, f32 duration, scene::EasingType easing = scene::EasingType::EaseInOut);

    // Rotation
    void setRotation(f32 angle);
    [[nodiscard]] f32 getRotation() const { return m_rotation; }

    void rotateTo(f32 angle, f32 duration, scene::EasingType easing = scene::EasingType::EaseInOut);
...
private:
    ...
    scene::EasingType m_transitionEasing = scene::EasingType::Linear;
...
private:
    ...
    scene::EasingType m_cameraTransitionEasing = scene::EasingType::Linear;
};
