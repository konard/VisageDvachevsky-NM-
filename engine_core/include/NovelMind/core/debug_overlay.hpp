...
public:
    ...
    void setMetric(const std::string& name, const std::string& value, const std::string& category = "");
    void setMetric(const std::string& name, i64 value, const std::string& category = "");
    void setMetric(const std::string& name, f64 value, const std::string& category = "", int precision = 2);
