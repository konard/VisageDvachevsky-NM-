 ...
 *
 * The Multi-Pack Manager provides a sophisticated pack file system that supports:
 *
...
public:
     ...
     */
    [[nodiscard]] std::vector<std::string> listResources(ResourceType type = ResourceType::Unknown) const;
     ...
     */
    Result<std::vector<u8>> readResourceFromPack(const std::string& packId, const std::string& resourceId);
