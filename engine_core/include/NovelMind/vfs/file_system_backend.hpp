...
public:
    ...
    [[nodiscard]] virtual std::vector<ResourceId> list(ResourceType type = ResourceType::Unknown) const = 0;
...
public:
    ...
    void addResource(const std::string& id, std::vector<u8> data, ResourceType type = ResourceType::Data);
