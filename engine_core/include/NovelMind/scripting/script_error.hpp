...
struct ScriptError
{
    ...
    [[nodiscard]] std::string format() const
    {
        ...
        switch (severity)
        {
            case Severity::Hint:    result = "hint"; break;
...
public:
    ...
    [[nodiscard]] const std::vector<ScriptError>& all() const
    {
        return m_errors;
    }
...
[[nodiscard]] inline const char* errorCodeDescription(ErrorCode code)
{
    switch (code)
    {
        ...
        case ErrorCode::UnterminatedString:      return "Unterminated string literal";
        case ErrorCode::InvalidNumber:           return "Invalid number format";
        case ErrorCode::InvalidEscapeSequence:   return "Invalid escape sequence";
        case ErrorCode::UnterminatedComment:     return "Unterminated block comment";

        // Parser errors
        case ErrorCode::UnexpectedToken:         return "Unexpected token";
        case ErrorCode::ExpectedIdentifier:      return "Expected identifier";
        case ErrorCode::ExpectedExpression:      return "Expected expression";
        case ErrorCode::ExpectedStatement:       return "Expected statement";
        case ErrorCode::ExpectedLeftBrace:       return "Expected '{'";
        case ErrorCode::ExpectedRightBrace:      return "Expected '}'";
        case ErrorCode::ExpectedLeftParen:       return "Expected '('";
        case ErrorCode::ExpectedRightParen:      return "Expected ')'";
        case ErrorCode::ExpectedString:          return "Expected string";
        case ErrorCode::InvalidSyntax:           return "Invalid syntax";

        // Validation - Characters
        case ErrorCode::UndefinedCharacter:      return "Undefined character";
        case ErrorCode::DuplicateCharacterDefinition: return "Duplicate character definition";
        case ErrorCode::UnusedCharacter:         return "Unused character";

        // Validation - Scenes
        case ErrorCode::UndefinedScene:          return "Undefined scene";
        case ErrorCode::DuplicateSceneDefinition: return "Duplicate scene definition";
        case ErrorCode::UnusedScene:             return "Unused scene";
        case ErrorCode::EmptyScene:              return "Empty scene";
        case ErrorCode::UnreachableScene:        return "Unreachable scene";

        // Validation - Variables
        case ErrorCode::UndefinedVariable:       return "Undefined variable";
        case ErrorCode::UnusedVariable:          return "Unused variable";
        case ErrorCode::VariableRedefinition:    return "Variable redefinition";
        case ErrorCode::UninitializedVariable:   return "Use of uninitialized variable";

        // Validation - Control flow
        case ErrorCode::DeadCode:                return "Dead code detected";
        case ErrorCode::InfiniteLoop:            return "Possible infinite loop";
        case ErrorCode::UnreachableCode:         return "Unreachable code";
        case ErrorCode::MissingReturn:           return "Missing return statement";
        case ErrorCode::InvalidGotoTarget:       return "Invalid goto target";

        // Validation - Type
        case ErrorCode::TypeMismatch:            return "Type mismatch";
        case ErrorCode::InvalidOperandTypes:     return "Invalid operand types";
        case ErrorCode::InvalidConditionType:    return "Invalid condition type";

        // Validation - Resources
        case ErrorCode::UndefinedResource:       return "Undefined resource";
        case ErrorCode::InvalidResourcePath:     return "Invalid resource path";

        // Validation - Choice
        case ErrorCode::EmptyChoiceBlock:        return "Empty choice block";
        case ErrorCode::DuplicateChoiceText:     return "Duplicate choice text";
        case ErrorCode::ChoiceWithoutBranch:     return "Choice without branch";

        // Compiler errors
        case ErrorCode::CompilationFailed:       return "Compilation failed";
        case ErrorCode::TooManyConstants:        return "Too many constants";
        case ErrorCode::TooManyVariables:        return "Too many variables";
        case ErrorCode::JumpTargetOutOfRange:    return "Jump target out of range";
        ...
        case ErrorCode::InvalidInstruction:      return "Invalid instruction";
